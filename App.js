/**
 * file: App.js
 * author: Sourav Naskar <snp734@uregina.ca>
 * version: 0.1
 * date-create: Feb-2-2022
...
const EggClicker = () => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: bgColor }]}>
      ...
      <Pressable
        onPress={() => {
          setCount(count + 1), Vibration.vibrate([1, 100], false);
        }}
        onLongPress={() => {
          Vibration.vibrate([1, 900], false), setCount(0),crack=true
        }}>
